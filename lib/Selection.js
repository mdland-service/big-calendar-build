...
function () {
  ...
  _proto._addLongPressListener = function _addLongPressListener(handler, initialEvent) {
    ...
    // var touchStartListener = addEventListener('touchstart', this._handleClickEvent);
    ...
    if (initialEvent) {
      // this._handleClickEvent(initialEvent)
      // cleanup()
  ...
  _proto._handleInitialEvent = function _handleInitialEvent(e) {
    ...
    // console.log("result aint falsy boi, heres e.type: ", e.type)
    switch (e.type) {
      case 'mousedown':
  ...
  _proto._handleMoveEvent = function _handleMoveEvent(e) {
    //console.log("we movin boii")
    if (this._initialEventData === null) {
      return;
    }
   // console.log("initialeventdata is NAHT null")
    var _this$_initialEventDa = this._initialEventData,
        x = _this$_initialEventDa.x,
        y = _this$_initialEventDa.y;
  //  console.log("heres this$_initialeventda x and y:", x, y)
